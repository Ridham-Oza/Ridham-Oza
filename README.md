...
class RidhamOza:
    def __init__(self):
        self.name       = "Ridham Oza"
        self.from_      = "Ahmedabad, Gujarat, India 🇮🇳"
        self.journey    = "Career Switcher → AI Engineer ⚡"
        self.focus      = ["Machine Learning", "Deep Learning",
                           "Generative AI", "LLMs", "Data Analysis"]
        self.stack      = ["Python", "PyTorch", "TensorFlow", "HuggingFace",
                           "LangChain", "SQL", "Power BI", "Streamlit"]
        self.mindset    = "Build first. Learn always. Ship fast."
        self.currently  = "Fine-tuning LLMs + building Agentic AI systems"
        self.goal       = "Create AI that solves real problems at scale"
...
![XGBoost](https://img.shields.io/badge/XGBoost-189ACA?style=for-the-badge&logo=xgboost&logoColor=white)
...
**Location:** Remote 🌍 · Hybrid 🏢 · Ahmedabad, India 📍
